...
This Terraform module creates a VPC with public and private subnets in a development environment.
...
- Creates a VPC Endpoint for different servies 
...
or  you can also write variables and terraform.tfvars files for multiple vpc creation.
